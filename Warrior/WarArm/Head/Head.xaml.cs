...
public partial class Head : ContentPage
{
    ...
    private async void OnPickerSelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (selectedIndex == 0)
        {
            await Navigation.PushAsync(new Warrior.WarArm.Head.FEPatHat());
        }
        else if (selectedIndex == 1)
        {
            await Navigation.PushAsync(new Warrior.WarArm.Head.FEMatSunHat());
        }
        else if (selectedIndex == 2)
        {
            await Navigation.PushAsync(new Warrior.WarArm.Head.HelmofLight());
        }
    }
}