...
public partial class Lvl1_10 : ContentPage
{
	public Lvl1_10()
	{
		InitializeComponent();
    ...
    {
        await Navigation.PushAsync(new Maraudar.MarWpn.Lvl1_10.CloudAxe());
    }

    private async void Button_Clicked_1(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new Maraudar.MarWpn.Lvl1_10.BronzeLabrys());
    }

    private async void Button_Clicked_2(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new Maraudar.MarWpn.Lvl1_10.BronzeWarAxe());
    }

    private async void Button_Clicked_3(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new Maraudar.MarWpn.Lvl1_10.AugHellhoundBaxe());
    }

    private async void Button_Clicked_4(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new Maraudar.MarWpn.Lvl1_10.WeatheredWarAxe());
    }

    private async void Button_Clicked_5(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new Maraudar.MarWpn.Lvl1_10.HellhoundBaxe());
    }

    private async void Button_Clicked_6(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new Maraudar.MarWpn.Lvl1_10.ShroyuAxe());
    }
